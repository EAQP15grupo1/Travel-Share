...
function getEventData() {
    var url_TS = "http://10.89.40.14:3000/event/" + window.localStorage.getItem("eventID");
    $.ajax({
        url: url_TS,
        type: 'GET',
        crossDomain: true,
...
function getEventComments() {
    var url_TS = "http://10.89.40.14:3000/messages/event/" + window.localStorage.getItem("eventID");
    $.ajax({
        url: url_TS,
        type: 'GET',
        crossDomain: true,
...
$("#postBtn").click(function postMessage() {
    ...
    if (content == "") {
        ...
        $.ajax({
            url: "http://10.89.40.14:3000/messages",
            type: 'POST',
            crossDomain: true,
...
$("#joinBtn").click(function joinEvent() {
    var joinURL = "http://10.89.40.14:3000/event/join/" + window.localStorage.getItem("eventID");
