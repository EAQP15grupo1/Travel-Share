(function () {
    ...
    //cat = randomCat();
    //uuid = color + '-' + cat;
    uuid = window.localStorage.getItem("username");
    ...
    //$("#sub").channel = window.localStorage.getItem("userID");
    //$("#pub").channel = window.localStorage.getItem("userID");
    //$("#his").channel = window.localStorage.getItem("userID");
    template.channel = 'polymer-chat';
    template.uuid = uuid;
